...
if string.lower(ui_vars.color_scheme) ~= ("awe-light" or "awe-dark") then
    ui_vars.color_scheme = "awe-dark"
end
...
theme.icon_var      = "CaskaydiaMono NF"
theme.icon_alt_var  = "CaskaydiaMono NF"
...
-- gaps/border thing
-- ~~~~~~~~~~~~~~~~~
theme.useless_gap           = dpi(ui_vars.gaps + 10) or 7
...
theme.taglist_bg_occupied = theme.bg_3
theme.taglist_fg_occupied = theme.fg_color
theme.taglist_bg_empty = theme.bg_3
