...
awful.keyboard.append_global_keybindings({
    ...
    { description = "Show Visaulizer", group = "launcher" }),
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "i", function()
		awful.spawn("pkill -USR1 redshift", false)
	end,
    { description = "Toggle Dim", group = "control" }),

	awful.key({ modkey }, "p", function()
		awful.spawn("alacritty -e pipe-viewer -n -s", false)
	end,
    { description = "Launch YT", group = "launcher" }),

	awful.key({ modkey }, "b", function()
		awful.spawn("buckle")
	end,
    { description = "Enable Bucklespring", group = "control" }),

	awful.key({ modkey, shift }, "b", function()
		awful.spawn("killall buckle", false)
	end,
    { description = "Disable Bucklespring", group = "control" }),

    awful.key({}, "Print", function() 
        awful.util.spawn(home_var .. "/scripts/sc", false)
    end,
    ...
    awful.key({ modkey }, "0", function() 
        awful.util.spawn(home_var .. "/scripts/dupe", false)
    end,
    {description = "Dupe items", group = "control"}),
	
    awful.key({ modkey, shift }, "0", function()
		awful.spawn("killall dupe", false)
	end,
    { description = "Disable dupe", group = "control" }),
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86AudioRaiseVolume",
            function() awful.spawn("wpctl set-volume @DEFAULT_SINK@ 2%+", false) 
    end,
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "XF86PowerOff", function () require("mods.exit-screen") awesome.emit_signal('module::exit_screen:show') end,
